...
export default function QuoteForm() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      console.error(e);
      setError(\"Something went wrong sending your request. Please try again or call (617) 863-7629.\");
      setStatus(\"error\");
    }
  }
    ...
    >
      ...
      <div className=\"grid gap-3 sm:grid-cols-2\">
        ...
        <div className=\"space-y-1\">
          ...
          <select id=\"preferredTiming\" name=\"preferredTiming\" defaultValue=\"Flexible\">
      ...
      <div className=\"space-y-1\">
        ...
        <select id=\"serviceType\" name=\"serviceType\" required defaultValue=\"Interior painting\">
          {[
            \"Interior painting\",
            \"Exterior painting\",
            \"Small remodeling project\",
